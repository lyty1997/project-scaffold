...
[English](codex-workflow.md) | 中文

适用于复杂实现、跨文件或跨层改动；简单只读问答遵守根 [AGENTS-zh.md](../../AGENTS-zh.md) 即可。

## 决策门

- 先检查相关设计、`docs/architecture/open-decisions.md`、`docs/architecture/open-decisions-zh.md`、现有实现和工具输出。
...
- 运行项目已有的格式化、lint、typecheck、测试和相关专项检查；基础门禁见 [质量门禁](../../docs/architecture/quality-gates-zh.md)。
- UI 改动必须实际渲染；无法完成某项验证时说明原因和风险。
- 同时更新 `docs/progress.md` 与 `docs/progress-zh.md`，记录完成项、验证证据和遗留项。
