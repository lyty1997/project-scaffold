...
| `docs/`、Markdown、Archify 图表 | [Markdown 文档](rules/markdown-docs.md) |
...
任务触及脚本、跨平台、Git hooks、扫描器或 Archify 时，再查 [已知注意事项](known-issues.md)。规则冲突按“系统 / 开发者 / 用户显式指令 → 根 `AGENTS.md` → `docs/` 设计 → 本目录执行细则”处理；同级冲突无法查证时请用户决定。
